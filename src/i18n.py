...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "welcome.offline_installer": "Offline Installer (2nd USB)",
    ...
    "es": {
        ...
        "welcome.offline_installer": "Instalador sin conexión (2.ª USB)",
    ...
    "pt": {
        ...
        "welcome.offline_installer": "Instalador offline (2.º USB)",
    ...
    "zh": {
        ...
        "welcome.offline_installer": "离线安装器（第二个 U 盘）",
